    ...
    with sync_playwright() as p:
        ...
        for _ in range(20):
            ...
            if focused_info:
                ...
                if not focus_sequence or focus_sequence[-1]['selector'] != focused_info['selector']:
                    focus_sequence.append(focused_info)
                    if not focused_info['isVisible']:
                        anomalies.append(f"El elemento {focused_info['selector']} recibe el foco pero no es visible.")
